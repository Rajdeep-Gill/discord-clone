...
export const ServerChannel = ({
    ...
    return (
        <button onClick = {() => {}}
        className = {cn(
            "group px-2 py-2 ropunded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition mb-1",
            params?.channelId === channel.id && "bg-zinc-700/10 dark:bg-zinc-700/50"
        )}>
            <Icon className = "flex-shring-0 w-5 h-5 text-zinc-500 dark:text-zinc-400" />
            <p
                className = {cn(
